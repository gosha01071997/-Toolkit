...
const searchText = item => {
  if (!searchable.has(item)) searchable.set(item, normalizeCatalogText([item.manufacturer,item.model,item.subtype,item.equipmentType,item.applications?.join(" ")].join(" ")));
