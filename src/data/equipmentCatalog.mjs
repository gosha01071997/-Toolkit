...
export const EQUIPMENT_CATALOG = [
  { id: "akip-3208", manufacturer: "АКИП", model: "АКИП-3208", equipmentType: "signal_generator", specifications: {}, applications: [], compatibleAccessories: [], sources: [{ type: "official_product_page", url: "https://prist.ru/productions/generatory-signalov/", title: "ПриСТ — генераторы сигналов АКИП" }], verificationStatus: "partially_verified" },
  ...
  { id: "tekbox-tbcp1-250", manufacturer: "Tekbox", model: "TBCP1-250", equipmentType: "current_probe", specifications: {}, applications: [], compatibleAccessories: [], sources: [{ type: "official_product_page", url: "https://www.tekbox.com/product/tbcp1-250-rf-current-monitoring-probe/", title: "Tekbox TBCP1-250 RF current monitoring probe" }], verificationStatus: "partially_verified" },
];
const aliases = { "генератор": "signal generator", "генератор сигналов": "signal generator", "токосъёмник": "current probe", "токовый пробник": "current probe", "лисн": "lisn", "эквивалент сети": "lisn", "анализатор спектра": "spectrum analyzer" };
...
export const visibleSpecifications = model => Object.entries(model?.specifications || {}).filter(([, value]) => value !== null && value !== undefined && value !== "");
