export const EQUIPMENT_TYPES = ["Генератор", "Усилитель", "Аттенюатор", "Антенна", "Инжектор / BCI probe", "Токосъёмник", "Токовый пробник", "Анализатор / измерительный приёмник", "LISN", "CDN", "Кабель", "Кабель / тракт", "Вспомогательное оборудование", "Другое"];
